      ...
      <div className="rounded-2xl min-w-[8.5625rem] max-w-[21.9375rem]">
        <div className="relative w-full h-[17.25rem] rounded-tl-2xl rounded-tr-2xl">
          <Image
            ...
            alt="image"
          />
          <div className="bgBlue absolute top-3 left-4 px-3 py-2 text-white font-medium text-sm flex justify-center items-center rounded-[1.875rem]">
            <p>Total Sales: </p>
            <p className="ml-1">$3.7K</p>
          </div>
        </div>
