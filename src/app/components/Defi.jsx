        ...
        <div className='w-full bg-[#F4F4F4] p-6 lg:p-8 xl:p-10'>
            <div className='mx-auto w-full md:w-11/12 lg:w-5/6 block lg:flex lg:items-center lg:justify-between'>
                <div className="mx-auto w-full sm:w-11/12 md:w-1/2 flex flex-col justify-center items-center md:block">
                    <h2 data-aos="fade-up" className='my-1 text-sm lg:text-lg font-semibold text-[#1199fa]'>CRYPTO.COM DEFI</h2>
                    <h1 data-aos="fade-up" className='my-3 text-[2rem] lg:text-5xl font-semibold text-black'>DeFi Made Simple</h1>
                    <div className="mt-8">
                        {
                            defiListArr?.length>0 && defiListArr?.map((item,i)=>(
                                <h5 data-aos="fade-up" className='my-3 text-base lg:text-2xl font-semibold text-[#7D7D7D]' key={i}>
                    ...
                    <div className="mt-16 mb-8 xl:flex xl:flex-row-reverse xl:gap-4">
                        <div className="my-2">
                            <Link data-aos="fade-up" href="#" className='inline-block bg-[#0e213b] border-[1px] border-[#f4f4f4] text-[#FFFFFF] text-base sm:text-lg font-semibold capitalize  px-6 py-3  rounded-[40px]'>
                        ...
                        <div className="my-2 hidden lg:block">
                            <Link data-aos="fade-up" href="#" className='inline-block text-[#0e213b] border-[1px] border-[#0e213b] hover:bg-[#1335641a] text-base sm:text-lg font-semibold capitalize  px-6 py-3  rounded-[40px]'>
                                Get DeFi Wallet 
                            </Link>
                        </div>
                        <div className="my-2 mt-6 block lg:hidden">
                            <Link data-aos="fade-up" href="#" className='inline-block text-[#0e213b] border-[1px] border-[#0e213b]  text-lg font-semibold capitalize  px-6 py-3  rounded-[40px]'>
