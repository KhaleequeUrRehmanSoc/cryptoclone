        ...
        <div className='w-full min-h-[1526px] pt-[96px] pb-[72px] crypto_exchange_container'>
            <div className='mx-auto mb-[196px] w-full md:w-3/4 lg:w-5/6'>
                <div className='mx-auto w-11/12 sm:w-1/2 md:w-4/5 flex flex-col justify-center items-center text-center'>
                    ...
                    <h1 data-aos="fade-up" className='my-1 text-[2rem] lg:text-5xl font-semibold text-white'>Trade with confidence on the world’s fastest and most secure crypto exchange</h1>
                    {/* <div className='my-3'>
            ...
            <div className='w-full min-h-[463px] lg:min-h-[245px] md:min-h-[524px]'>
                <div className='w-1/2 min-h-full hidden  lg:flex lg:flex-col lg:items-center lg:justify-center'>
                    <div className='my-3 text-center'>
                        ...
                        <div className="mt-5">
                            <Link data-aos="fade-up" href="#" className='inline-block text-[#F4F4F4] border-[1px] border-[#F4F4F4] bg-transparent hover:bg-[#ffffff1a] text-lg font-semibold capitalize  px-6 py-3  rounded-[40px]'>
                    ...
                    <div className='mt-8 text-center'>
                        <h2 className='my-1 text-sm lg:text-lg font-semibold text-[#1199fa] uppercase'>DESKTOP</h2>
                        <div className="mt-5">
                            <Link data-aos="fade-up" href="#" className='inline-block text-[#F4F4F4] border-[1px] border-[#F4F4F4] bg-transparent text-lg font-semibold capitalize  px-6 py-3  rounded-[40px]'>
            ...
            <div className='p-6 md:p-0 md:mx-auto w-11/12 sm:w-1/2 md:w-4/5 md:flex md:gap-5 md:items-center'>
                {
                    [1,2,3].map((item,i)=> (
                        <div data-aos="fade-up" className='my-7 w-full md:w-1/3' key={i}>
