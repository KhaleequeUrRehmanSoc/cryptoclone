                        ...
                        <div className='mt-6 pb-2.5 sticky top-16'>
                            ...
                            <div className='mt-2.5 w-full'>
                                <div className='flex box-border'>
                                    ...
                                    toggleFilters && (
                                    <div>
                                    <div className='max-w-[330px] w-[326px] h-[100dvh] overflow-y-auto sticky top-0 z-auto'>
                                    ...
                                    <div className='pl-6 flex-grow '>
                                        <div className='sticky top-0 z-10 pb-2.5 flex flex-col md:flex-row gap-4 md:gap-0 md:justify-between md:items-center'>
