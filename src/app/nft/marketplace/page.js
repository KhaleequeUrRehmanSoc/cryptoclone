            ...
            <section className='w-full min-h-screen bg-[#0b1426]'>
                <div className='px-6 pt-6 w-full'>
                    <div className='mt-2'>
                        ...
                        <div className='mt-6 pb-2.5 sticky top-16'>
                            ...
                            <div className='mt-2.5 w-full'>
                                <div className='flex box-border'>
                                    ...
                                    <div className='max-w-[330px] w-[326px] md:h-[100dvh] overflow-y-auto md:sticky md:top-0 z-auto'>
                                    ...
                                    <div className='pl-6 flex-grow '>
                                        <div className='md:sticky md:top-0 md:z-10 pb-2.5 flex flex-wrap gap-4 justify-between items-center bg-[#0b1426]'>
