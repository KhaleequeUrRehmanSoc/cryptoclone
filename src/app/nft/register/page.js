...
const Register = () => {
  ...
  const submitHandler = async (e) => {
    ...
    // const resdata = await fetch('http://localhost:3000/api/auth/register', {
    const resdata = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/auth/register`, {
      method: "POST",
      headers: {
    ...
    if(resdata.ok){
      notify()
      console.log('resdata register ',resdata)
      setTimeout(() => {
                ...
                <div className="w-full">
                  ...
                  <div className="w-full">
                    <form className='my-1' onSubmit={submitHandler}>
                      ...
                      <div className="mt-6">
                        <button className='min-w-[8rem] h-12 w-full navbarBtnbg text-white rounded font-semibold text-center py-2 px-6 outline-0' type='submit' >Sign Up</button>
                      </div>
                  ...
                  <div className='w-full h-fit'>
                    {
                      ...
                      //       <div className='flex gap-5 items-center'>
                      //         <DemoSvg />
                      //         <h3 className='text-[1.25rem] font-medium'>Drops</h3>
                      //       </div>
                      //       <p className='mt-1.5 text-[#b0b4b9] text-base font-medium'>Purchase NFTs that are directly sold by top Creators</p>
                      //     </div>
                      //   </>
                      // ))
                    }
