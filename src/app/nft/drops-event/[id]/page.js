...
import DropsEventHeaderSection from './components/DropsEventHeaderSection'
...
const DropsDetail = () => {
    ...
    const tabsDataArr = [
        // {tabLabel:"Info",tabPanel:"Item One"},
        // {tabLabel:"Shop",tabPanel:"Item Two"},
        {tabLabel:"Info",tabPanel:""},
        {tabLabel:"Shop",tabPanel:"I"},
    ]
  ...
  return (
    ...
    <section className='w-full min-h-screen text-white bg-[#0b1426]'>
            ...
            <DropsEventHeaderSection />
            {/* <main className='w-full min-h-screen my-20 px-3 md:px-8 lg:px-12'>  */}
