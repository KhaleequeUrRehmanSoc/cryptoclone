...
const LiveIconSvg = () => {
    return (
        <svg width={24} height={25} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M12.2513 22.5196C17.7748 22.5196 22.2525 18.0419 22.2525 12.5183C22.2525 6.9948 17.7748 2.51709 12.2513 2.51709C6.72771 2.51709 2.25 6.9948 2.25 12.5183C2.25 18.0419 6.72771 22.5196 12.2513 22.5196ZM13 7.01709C13 6.46481 12.5523 6.01709 12 6.01709C11.4477 6.01709 11 6.46481 11 7.01709V13.3921V14.3921H12H17.25C17.8023 14.3921 18.25 13.9444 18.25 13.3921C18.25 12.8398 17.8023 12.3921 17.25 12.3921H13V7.01709Z" fill="white" /></svg>
    )
}

const DropsEventHeaderSection = () => {

  return (
    <>
    <section className='w-full min-h-[30rem] bg-[#0b1426] relative'>
        <div className='dropsEventHeaderSectionBg'>
        </div>
        <div className='w-full min-h-[30rem] flex justify-center items-center bg-cover bg-no-repeat p-6 md:p-12'>
...
export default DropsEventHeaderSection
...
//         <div className='dropsEventHeaderSectionBg'>
//         </div>
//         <div className='relative w-full h-full flex justify-center items-center bg-cover bg-no-repeat p-6 md:p-12'>
//             <div className='w-full h-[480px]'>
//                 <Image
//                 className="object-cover"
//                 src="/assets/images/drops/dropSectionBgImage.png"
//                 // width={480}
//                 // height={480}
//                 fill
//                 alt="bg pic"
